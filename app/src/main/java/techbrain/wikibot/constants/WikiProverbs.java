...
public class WikiProverbs {
	...
	static ArrayList<String> proverbs = new ArrayList<>(Arrays.asList(
		...
		"Chi vuol provar le pene dell\'Aquila d\'inverno.",
		...
		"'I miei datteri sono più dolci', dice il palma.",
		...
		"Non ogni domanda vuole risposta.",
		...
		"Per Santa Caterina, le bestie fuori dalla cascina.",
